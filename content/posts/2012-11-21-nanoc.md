...
By using the provided colorize_syntax nanoc helper, you can easily colorize your `<pre><code>` blocks. You just have to still indent it and put a comment first line.
